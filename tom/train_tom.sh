...
python3 /scratch/c.c1984628/my_diss/tom/help.py --checkpoint_dir "/scratch/c.c1984628/my_diss/tom/checkpoints/TOM_perp_loss" --name "TOM_perp_loss" --save_count 10000