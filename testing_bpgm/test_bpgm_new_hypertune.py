...
def main():
    ...
    for i in range(len(dataset.filepath_df)):
        ...
        #im.save(os.path.join("/scratch/c.c1984628/my_diss/testing_bpgm", "given_for_new.png"))



        im = Image.fromarray(warped_cloth).save("/scratch/c.c1984628/my_diss/testing_bpgm/new_lpips_hypertune/warped_cloth_new.png")
        #im = Image.fromarray(warped_cloth_masked).save("/scratch/c.c1984628/my_diss/bpgm/results/sample/warped_cloth_masked.png")
        im = Image.fromarray(warped_mask).save("/scratch/c.c1984628/my_diss/testing_bpgm/new_lpips_hypertune/warped_mask_new.png")
        ...
        im = Image.fromarray(warped_cloth).save("/scratch/c.c1984628/my_diss/testing_bpgm/new_lpips_hypertune/warped_cloth_new.png")
        im = Image.fromarray(warped_cloth_swap).save("/scratch/c.c1984628/my_diss/testing_bpgm/new_lpips_hypertune/viton_bpgm_warp_new.png")
